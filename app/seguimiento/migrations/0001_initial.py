    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cuenta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seguimiento.cuenta')),
        ...
        migrations.AddField(
            model_name='cuenta',
            name='estudiante',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seguimiento.estudiante'),
        ),
        migrations.CreateModel(
            name='Capacitaciones',
            fields=[
